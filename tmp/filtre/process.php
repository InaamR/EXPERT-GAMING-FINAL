...
if(isset($_GET["action"]))
{
	...
	$query = "
	SELECT gender, COUNT(sample_id) AS Total FROM sample_data GROUP BY gender
	";
	...
	$query = "
	SELECT brand, COUNT(sample_id) AS Total FROM sample_data GROUP BY brand
	";
	...
	{
		$query = "
		SELECT COUNT(sample_id) AS Total FROM sample_data 
		WHERE ".$key." 
		";
		$sub_data = array();
